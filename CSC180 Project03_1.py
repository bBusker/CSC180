...
def build_semantic_descriptors_from_files(filenames):
    ...
    while i< len(sentences):     #error: divide by zero when 40%/50%/60% of sentences used? also, multiplying the length by 10 then integer division by 10 yields a different run time than simply running without dividing or multiplying
